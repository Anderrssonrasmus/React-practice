  ...
  return (
    <section className="menu"  ref={el => menu = el}>
        ...
        <div className="menu-board">
            <ul>
                 <li>
                    <Link to={"/"} onClick={handleNavbarOpen}>Home</Link>
                </li>
                <li>
                    <Link to={"/projects"} onClick={handleNavbarOpen}>Projects</Link>
                </li>
                <li>
                    <Link to={"/"} onClick={handleNavbarOpen}>About</Link>
                </li>
                <li>
                    <Link to={"/"} onClick={handleNavbarOpen}>Contact</Link>
                </li>
            </ul>
        </div>
    </section>
